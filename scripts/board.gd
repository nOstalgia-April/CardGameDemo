...
func _ready() -> void:
	...
	BattleEventBus.connect("turn_started", cb)
	var cb_place: Callable = Callable(self, "_on_place_card_requested")
	BattleEventBus.connect("place_card_requested", cb_place)
	var cb_dead: Callable = Callable(self, "_on_unit_died_event")
	BattleEventBus.connect("unit_died", cb_dead)
	var cb_action: Callable = Callable(self, "_on_unit_action_requested")
	BattleEventBus.connect("unit_action_requested", cb_action)
	var cb_attack: Callable = Callable(self, "_on_unit_attack_requested")
	BattleEventBus.connect("unit_attack_requested", cb_attack)
	var cb_cell: Callable = Callable(self, "_on_unit_cell_requested")
	BattleEventBus.connect("unit_cell_requested", cb_cell)
	var cb_neighbors: Callable = Callable(self, "_on_cell_neighbors_requested")
	BattleEventBus.connect("cell_neighbors_requested", cb_neighbors)
	var cb_units: Callable = Callable(self, "_on_units_requested")
	BattleEventBus.connect("units_requested", cb_units)
	var cb_avail: Callable = Callable(self, "_on_available_cells_requested")
	BattleEventBus.connect("available_cells_requested", cb_avail)
	var cb_clear: Callable = Callable(self, "_on_clear_available_cells_requested")
	BattleEventBus.connect("clear_available_cells_requested", cb_clear)
	update_visibility()
